    ...
    public function store(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'processItems.*.requirements'                   => 'required|string|max:2000',
                'processItems.*.potential_failure_mode'         => 'required|string|max:2000',
                'processItems.*.potential_effect_of_failure'    => 'required|string|max:2000',
                'processItems.*.potential_cause_of_failure'     => 'required|string|max:2000',
                ...
                'processItems.*.controls_prevention'            => 'required|string|max:2000',
                'processItems.*.controls_detection'             => 'required|string|max:2000',
